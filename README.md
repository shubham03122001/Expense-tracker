...
Overview
This service is responsible for providing authentication and authorization functionalities for the entire system. It handles user signup, login, JWT token generation, and refresh token management. The user credentials are securely stored in the database with passwords encrypted using industry-standard encryption techniques. This service serves as the central point for all authentication and authorization operations within the system.
